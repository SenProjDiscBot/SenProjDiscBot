            ...
            if not afkCheck:
                ...
                if message == None:
                    ...
                    afkEmbed = discord.Embed(
                        description=f"{ctx.author.mention} has gone afk. ",
                        color=0x000FF,
                    )
                    ...
                    afkEmbed2 = discord.Embed(
                        description=f"{ctx.author.mention} has gone afk `{message}`.",
                        color=0x000FF,
                    )
            ...
            for user in mention:
                ...
                if afkCheck:
                    ...
                    if len(afkMessage) == 0:
                        ...
                        afkEmbed5 = discord.Embed(
                            description=f"<@{userID}> is AFK", color=0x000FF
                        )
                        await message.reply(embed=afkEmbed5)
                    else:
                        # await message.reply(f"<@{userID}> is AFK: {afkMessage}")
                        afkEmbed6 = discord.Embed(
                            description=f"<@{userID}> is AFK: {afkMessage}",
                            color=0x000FF,
                        )
